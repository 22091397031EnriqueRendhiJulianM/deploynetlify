...
<table class="min-w-full border border-gray-300">
  <thead>
    <tr>
      ...
      <th class="px-6 py-3 bg-gray-100 border-b text-left">Pengarang</th>
      <th class="px-6 py-3 bg-gray-100 border-b text-left">Tahun</th>
      <th class="px-6 py-3 bg-gray-100 border-b text-left">Jumlah</th>
      <th class="px-6 py-3 bg-gray-100 border-b text-center">Aksi</th>
    </tr>
  </thead>
  <tbody>
  </tbody>
...
<form class="max-w-sm mx-auto" onsubmit="return handleAddForm(event)">
  ...
  <div class="mb-4">
    <label for="author" class="block text-gray-700 font-semibold mb-2">Pengarang</label>
